...
public interface EntitiesListPresenter<T1 extends ProfileDependedEntity, T2 extends ProfileDependedForm, T3 extends RecyclerView.ViewHolder>
        extends MenuItemCompat.OnActionExpandListener {
    ...
    void setDataToAdapter(DataPostSetAdapter<T1, T3> dataPostSetAdapter);
