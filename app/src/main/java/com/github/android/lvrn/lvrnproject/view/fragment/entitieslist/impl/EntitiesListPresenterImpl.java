...
public abstract class EntitiesListPresenterImpl<T1 extends ProfileDependedEntity, T2 extends ProfileDependedForm, T3 extends ViewHolder>
        implements EntitiesListPresenter<T1, T2, T3> {
    ...
    @Override
    public void setDataToAdapter(DataPostSetAdapter<T1, T3> dataPostSetAdapter) {
