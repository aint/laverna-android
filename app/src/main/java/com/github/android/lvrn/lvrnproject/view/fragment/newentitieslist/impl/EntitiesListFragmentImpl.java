...
public abstract class EntitiesListFragmentImpl<T1 extends ProfileDependedEntity, T2 extends ProfileDependedForm<T1>>
    ...
    protected EntitiesListPresenter<T1, T2> mEntitiesListPresenter;

//    public static final String TOOLBAR_TITLE = "All Notes"; //TODO: add to constructor

    private Unbinder mUnbinder;

    protected DataPostSetAdapter<T1> mEntitiesRecyclerViewAdapter;
...
//            ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(TOOLBAR_TITLE); TODO: after use constructor
        }
    }
